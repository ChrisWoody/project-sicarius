namespace Assets.Scripts.Gun
{
    public static class GunTypeFactory
    {
        private static readonly GunType[] GunTypes =
        {
            ...
            GunType.Create(Firerate.Fast, Damage.Low, spread: Spread.Small, autoFiring: true, shootThroughEverything: false),
            ...
            GunType.Create(Firerate.Medium, Damage.High, spread: Spread.Wide, autoFiring: true, shootThroughEverything: true),
        };
